...
I'm a Back-End Developer with strong experience in building scalable and maintainable APIs using Java, Spring Boot, and Quarkus. I specialize in designing microservices architectures, integrating systems through RESTful APIs, and ensuring clean, efficient code.

I’ve worked on projects involving:

Java + Spring Boot for API development and database integration

Quarkus for lightweight and high-performance microservices

Automation tasks using Python and Selenium
